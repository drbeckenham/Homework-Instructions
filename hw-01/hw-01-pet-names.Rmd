...
**Thought exercise:** Which of the above steps (updating the YAML, committing, and pushing) needs to talk to GitHub?[^1] Pushing needs to talk to Github.
...
The three most frequent names are Lucy, Charlie, and Luna. It is interesting that there are the largest amount for a N?A answer of 483.
...
Arrange(species,n) would do the arrangement as required.
*After completing this exercise:*
...
Unable to complete as there is an error with a missing file - libMagick++
