...
Each row represents a specific accident.
...
ggplot(data = accidents, aes(x = time, fill = severity)) +
  ...
  theme_minimal() + 
  labs(
    title = "Distribution of Accidents By Severity",
    subtitle = "Comparison of Weekday and Weekend Accident",
    x = "Time of Day",
    y = "Density",
    fill = "Severity"
  )
...
Weekday accidents apear tobeslightly more than weekend. This is probably owing to the commute that many people make for swork during the week.
- How does the severity of accidents vary by time of day?
The accidents tend to be worse during the late afternoon and evening hours.
- Are there any notable differences between weekdays and weekends?
ON Sundays, there is a dio in the data in the morning. Church? Football? It is hard to say. There also seem to be slightly less accidents.
...
ggplot(data = accidents, aes(x = highway, y = severity, fill = road_surface)) +
  geom_point(alpha = 0.5) +
  facet_wrap(~road_surface, ncol = 2) +
  theme_minimal() + 
  labs(
    title = "Distribution of Accidents By Highway",
    subtitle = "Comparison of Different Highways and Severity",
    x = "Highway",
    y = "Severity",
    fill = "Road Surface"
  )
...
**What variables were used:** Highway, Severity, road_surface

**Interpretation (3-4 sentences):** What patterns or insights does your visualization reveal?
Frost or Ice and Flooding show more slight accidents while dry roads show more fatalisties. That is very interesting and would make me look more at the data for correlations and causations.
